...
class ContentModerationService {
    constructor() {
        // Helper for debug logging (visible only when app debug enabled)
        this.logDebug = function(...args) {
            try {
                if (typeof window !== 'undefined' && window.APP_DEBUG) {
                    console.debug('[moderation]', ...args);
                }
            } catch (e) {
                // noop
            }
    ...
    async makeRequest(endpoint, data) {
        try {
            ...
            this.logDebug('moderation request error', error);
