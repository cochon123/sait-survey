...
<nav class="fixed bottom-0 left-0 right-0 frosted-card border-t border-primary/20 z-50">
    <div class="flex justify-between items-center px-8 py-2">
        ...
        <a href="{{ route('propositions.index') }}" class="flex items-center justify-center p-3 rounded-full transition-all {{ request()->routeIs('propositions.*') || request()->routeIs('propositions.index') ? 'depth-layer-3 text-brand shadow-md scale-110' : 'text-muted hover:depth-layer-2 hover:text-primary hover:scale-105' }}">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
