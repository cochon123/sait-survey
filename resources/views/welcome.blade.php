        ...
        <div class="max-w-7xl mx-auto">
            <div class="frosted-card p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="text-center p-6 frosted-input">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div class="order-2 md:order-1">
                        <div class="frosted-input p-6 rounded-2xl overflow-hidden">
                            <img src="{{ asset('image/students-speaking-with-an-instructor-at-sait.jpg') }}" alt="Students with Instructor" class="w-full h-64 object-cover rounded-lg">
                            <div class="p-4">
                    ...
                    <div class="order-1 md:order-2">
                        ...
                        <a href="{{ route('propositions.index') }}" class="btn-primary">View Propositions</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="frosted-card p-8">
                    ...
                    <div class="frosted-input p-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-3">
                                <button class="flex items-center space-x-1 text-green-500 hover:text-green-400 transition-colors">
                                    <span>👍</span><span class="text-sm">24</span>
                                </button>
                                <button class="flex items-center space-x-1 text-red-500 hover:text-red-400 transition-colors">
                ...
                <div class="text-center mt-12">
                    <a href="{{ route('propositions.index') }}" class="btn-secondary">View All Propositions</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 px-4">
        <div class="max-w-4xl mx-auto">
            <div class="frosted-card p-12 text-center">
                ...
                <a href="{{ route('propositions.index') }}" class="btn-primary">Submit Your Idea</a>
            </div>
        </div>
    </section>
</div>
